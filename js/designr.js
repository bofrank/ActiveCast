$(document).ready(function() {
	...
	Wordpress Functions
	==============================================*/
	//https://public-api.wordpress.com/rest/v1/sites/blog.liffft.com/posts/
	var tweetsLength = $('#twitter-slider').data('tweets-length'),
		widgetID = $('#twitter-slider').data('widget-id');


	//twitterFetcher.fetch(widgetID, 'twitter-slider', tweetsLength, true, false, true, '', false, handleTweets);
	$.getJSON( "https://public-api.wordpress.com/rest/v1/sites/blog.liffft.com/posts/?callback=?", null, handlePosts);
	function handlePosts(data){
		...
		while(n < x) {
			tweetsHtml += '<li><a href="'+ posts[n].URL +'"><span>' + posts[n].title + '</span></a>'+ posts[n].excerpt + '</li>';
			n++;
		}
	...
	==============================================*/
	/*
	$.backstretch('images/bg_11.jpg');

	$('body').append('<img class="preload-image" src="images/bg_11.jpg" style="display:none;"/>');
